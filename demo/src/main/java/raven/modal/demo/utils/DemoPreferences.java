...
public class DemoPreferences {
    ...
    private static boolean suggestionsEnabled = true;
    private static boolean webSearchEnabled = true;
    ...
    public static void setSuggestionsEnabled(boolean v) {
    ...
    public static void setWebSearchEnabled(boolean v) {
        webSearchEnabled = v;
    }
